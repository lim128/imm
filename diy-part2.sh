...
PKGS=(
  luci-app-openclash luci-app-passwall luci-app-daed golang chinadns-ng daed dns2socks-rust dns2socks dns2tcp geoview
  hysteria ipt2socks lua-neturl microsocks mosdns naiveproxy nikki pdnsd redsocks2 shadow-tls shadowsocks-libev shadowsocks-rust shadowsocksr-libev simple-obfs sing-box
